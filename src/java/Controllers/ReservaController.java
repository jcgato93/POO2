...
public class ReservaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        reserva.setFecha_reserva(request.getParameter("txtFechaReserva"));
        reserva.setFecha_salida(request.getParameter("txtFechaSalida"));
        
        
        String result=reserva.insertar(reserva,cliente);
